        ...
        <div class="row">
            <div class="col-md-12 mt-5">
                <div class="card">
                    ...
                    <div class="col-12">
                        <form action="<?php echo base_url(); ?>/dashboardAdminController/addImage/" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="fileUpload">Upload Image</label>
                                <input type="file" name="userProfileImage" id="fileUpload">
